...
Feature: Fan signup
  ...
  Scenario Outline: Fan signs up and mails are sent
    ...
    And I should see "<email> has subscribed to the World Racketeering Squad mailing list." in the email
    ...
    And I should see "<email> has subscribed to the World Racketeering Squad mailing list. You'll receive news and updates about what's happening." in the email
    And I should see "You are receiving these emails because <email> is subscribed to the World Racketeering Squad mailing list." in the email
