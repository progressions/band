...
xml.rss :version => "2.0" do
  xml.channel do
    xml.title "#{@global_settings.artist_name} Unified RSS"
    xml.description "The official RSS feed of #{@global_settings.artist_name}.  This feed includes blogs, news and lyrics."
